package nl.ovsoftware.oldenzaal.testprototypes.junit.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "nl.ovsoftware.oldenzaal.testprototypes.junit.repositories",
